...
bool sd_init_driver();
int sd_init_card(sd_card_t *);
int sd_write_blocks(sd_card_t *, const uint8_t *,
                    uint64_t , uint32_t );
int sd_read_blocks(sd_card_t *, uint8_t *, uint64_t ,
                   uint32_t );
bool sd_card_detect(sd_card_t *);
uint64_t sd_sectors(sd_card_t *);
